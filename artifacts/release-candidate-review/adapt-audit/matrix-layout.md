...
| ADAPT-23 (ten-foot lane cap) | **fixed in the pure function, INERT on the default path** — see ADAPT-L1 | probe 11 |
...
| **B-2e** | **at ten-foot gamepad** | **10 lanes — one MORE than the desktop's 9.** Probe 11, 14 cards, `minColumnWidth = 160`, `gap = 12` | 5 — `adaptive.columnsFor(1920, 160, 12, {distanceProfile = "ten-foot"})` answers 5, and the solver is documented to call the same function | **WRONG** (ADAPT-L1) |
