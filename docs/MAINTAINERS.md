...
|---|---|---|---|---|
| **core** | `src/core/`, `src/vendor/` | The reactive runtime: signals, memos, observers, effects, transactions and scopes. No engine, no layout. | `Facet.newCore` | `src/core/compose.luau`, `src/core/scope_impl.luau`, `src/core/contract.luau`, `src/core/profile.luau` |
