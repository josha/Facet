# Sponsor parity prompts — framework first, parallel game proof second
...
Use those two prompts in order. The shipped Sponsor Mode remains intact and default.
Neither prompt authorizes cutover or old-code removal.
