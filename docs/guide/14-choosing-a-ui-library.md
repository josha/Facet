...
| **Screen, billboard, world surface** | Three shipped render targets: `ScreenGui`, `BillboardGui`, and a flat two-dimensional `SurfaceGui` ([`api.md`](../reference/api.md), [`ADR-0063`](../adr/ADR-0063-surface-render-target.md)) | `[INFERENCE]` Any of them: a root renders into whatever instance container you give it | `[INFERENCE]` Any of them: you name the class you want | `[INFERENCE]` Any of them: you name the class you want |
...
[`ADR-0063`](../adr/ADR-0063-surface-render-target.md)).
...
Vide.** That core is `src/core/custom.luau`, and it was the selected foundation
of a recorded decision ([`ADR-0002`](../adr/ADR-0002-foundation-core-selection.md),
decision: `custom`) `[FACT]`. It gives you signals, memos, observers and effects,
